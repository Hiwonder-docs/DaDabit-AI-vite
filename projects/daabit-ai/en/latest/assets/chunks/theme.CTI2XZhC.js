const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.MlQ-0vmR.js","assets/chunks/framework.DFJPO_B_.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.MlQ-0vmR.js"), true ? __vite__mapDeps([0,1]) : void 0));
