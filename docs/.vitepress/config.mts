...
const docsBase = normalizeBase(process.env.DOCS_BASE || '/projects/daabit-ai/en/latest/')
...
const vitepressContainerTypes = new Set(['note', 'tip', 'warning', 'danger', 'details'])
...
function parseDocModuleMarker(line: string) {
  ...
  if (info && vitepressContainerTypes.has(info.toLowerCase())) {
    return null
  }
...
export default defineConfig({
  base: docsBase,
  title: 'DaDabit AI Documentation',
  description: 'DaDabit AI robot documentation',
    ...
    nav: [
      {
        text: 'Version',
        items: [
          { text: 'Latest', link: '/projects/daabit-ai/en/latest/' },
          { text: 'Starter Kit', link: '/projects/daabit-ai/en/starter-kit/' },
          { text: 'Standard Kit', link: '/projects/daabit-ai/en/standard-kit/' },
          { text: 'Advanced Kit', link: '/projects/daabit-ai/en/advanced-kit/' }
        ]
      },
