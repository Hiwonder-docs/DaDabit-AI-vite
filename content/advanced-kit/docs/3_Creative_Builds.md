...
This is a smart conveyor belt capable of transporting on command. Upon powering on, it enters a standby state. The WonderLLM large model supports controlling the start and stop of the conveyor belt using any voice command, with the 360° block motor driving the belt to rotate. Like an efficient logistics manager, it uses voice to easily control the material transport rhythm.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_1/media/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.25.2 Learning Objectives

1. Understand the 360° block motor and the WonderLLM large AI model, mastering hardware wiring and graphical programming for voice-controlled motor activation.
2. Master starting and stopping the conveyor using everyday spoken commands, understanding the complete process of voice-activated equipment operation.

### 3.25.3 Assembly Guide

 <iframe
    src="../_static/pdf/25_Smart_Conveyor.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
This model requires the use of the **Online LLM Mode**. If the online LLM mode is already active, this step can be skipped to proceed directly to the wiring guide. Otherwise, please refer to [Firmware Switching](./4.Software%20and%20Hardware%20Guide.md#anther4.5.10) to re-burn the corresponding firmware.

### 3.25.5 Wiring Guide

- Connect the WonderLLM module to port 6 of the micro:bit expansion board.

- Connect the 360° block servo to port S4 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S4.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_1/media/image100.png"  class="common_img" style="width:300px;" ></div>

### 3.25.6 Programming

#### (1) Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_1/media/image102.png"  class="common_img" style="width:300px;" ></div>

#### (2) Core Blocks Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_1/media/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |

#### (3) MCP Parameter Configuration

* Tool Name: `self.robot.setAction`

1. Tool Description: You are a Smart Conveyor. The parameters are as follows: 1. Switch: 0 or 1. When turned on, it returns 1 and when turned off, it returns 0.

2. AIModule Return Parameters: `[["action", "int", "0", "0", "1"]]`

   > [!NOTE]
   >
   > **The field name is `action`, of integer type, where the first 0 is the default value, the second 0 is the minimum value, and 1 is the maximum value.**

3. Whether to block until the call is completed: `true`

4. Whether there is data returned to the AIModule: `false`

5. Function: This MCP configuration defines the switch control tool of the Smart Conveyor for the AI module. It allows the AI to issue a 0 or 1 command to control the starting and stopping of the Smart Conveyor, returning 1 when opened and 0 when closed. The program will wait for the operation to complete during the call, and there is no need to send additional operation data back to the AI.

#### (4) Complete Program

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_1/media/image1.png"  class="common_img" style="width:900px;" ></div>

Program link: https://makecode.microbit.org/_aVCcW6XDg7bz. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Add a timed transmission function: the dot matrix display shows the running duration in seconds, and a voice command halts the conveyor while displaying the total elapsed time.
...
This is a smart serving bot capable of delivering meals on command. Upon powering on, it enters a standby state. The WonderLLM large model supports controlling the robot to follow the black track using any voice commands, automatically stopping when all four line-tracking probes detect the black line. Like a polite restaurant waiter, it uses voice commands to precisely deliver meals to designated positions.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_2/media/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.26.2 Learning Objectives

1. Understand 360° dual block motors, the 4-channel line follower sensor, and the large AI model, mastering coordinated wiring and programming for line-tracking combined with voice control.
2. Master the logic of voice-activated line-tracking cruise, utilizing line-tracking signals to implement automatic parking upon arrival at the destination.

### 3.26.3 Assembly Guide

 <iframe
    src="../_static/pdf/26_Serving_Bot.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the WonderLLM module to port 4 of the micro:bit expansion board.

- Connect the 4-channel line follower sensor to port 6 of the micro:bit expansion board.

- Connect the left 360° block servo to port S1 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S1.

- Connect the right 360° block servo to port S2 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S2.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_2/media/image100.png"  class="common_img" style="width:400px;" ></div>

### 3.26.6 Programming

#### (1) Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_2/media/image102.png"  class="common_img" style="width:250px;" ></div>

#### (2) Core Blocks Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image17.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the selected port to prepare for reading line detection data |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image16.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detection status of the specified channel of the 4-channel line follower sensor and return a boolean value to determine whether a black or white line is detected at the corresponding position |
| <img src="../_static/media/chapter_3/section_3/subsection_2/media/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |

#### (3) MCP Parameter Configuration

* Tool Name: `self.robot.setAction`

1. Tool Description: You are a delivery robot. The parameters are as follows: 1. Switch: 0 or 1. It returns 1 when turned on and 0 when turned off.

2. AIModule Return Parameters: `[["switch", "int", "0", "0", "1"]]`

   > [!NOTE]
   >
   > **The field name is `switch`, of integer type, where the first 0 is the default value, the second 0 is the minimum value, and 1 is the maximum value.**

3. Whether to block until the call is completed: `true`

4. Whether there is data returned to the AIModule: `false`

5. Function: This MCP configuration defines the switch control tool of the Serving Bot for the AI module. It allows the AI to issue a 0 or 1 command to control the starting and stopping of the Serving Bot, returning 1 when opened and 0 when closed. The program will wait for the operation to complete during the call, and there is no need to send additional operation data back to the AI.

#### (4) Complete Program

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_2/media/image1.png"  class="common_img" style="width:900px;" ></div>

Program link: https://makecode.microbit.org/_EoeU9tbrEiMg. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Pressing button **A** activates a delivery counter: the dot matrix display increments its count after each successful delivery, and pressing button **B** resets the count to zero to facilitate tracking the robot's workload.
...
This is a smart tumble dumper capable of hauling on command. Upon powering on, it enters a standby state. The WonderLLM large model supports controlling the dumper to start hauling using any voice commands. During line following, it automatically stops when encountering an intersection, and the servo controls the dumper bed to tilt and unload cargo to the left or right. Like a diligent site transporter, it uses voice commands to complete precise material transport and unloading tasks.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_3/media/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.27.2 Learning Objectives

1. Understand the 360° block motors, 270° dumping servo, 4-channel line follower sensor, and the large AI model, mastering coordinated wiring and programming for multiple components.
2. Learn to initiate line-tracking cruise via voice commands and automate cargo unloading at intersections by detecting line markers to distinguish left and right dump zones.

### 3.27.3 Assembly Guide

 <iframe
    src="../_static/pdf/27_Tumble_Dumper.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the 270° block servo to port S3 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S3.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_3/media/image100.png"  class="common_img" style="width:600px;" ></div>

> [!NOTE]
>
> **Before the first lesson involving the block servo, remove the building blocks from the servo and upload the program for this lesson to the micro:bit. Then turn on the power switch of the micro:bit expansion board and wait for the block servo to rotate to the initial position of 0 degrees before reinstalling the building blocks. This step can be skipped if the servo reset program has been executed previously.**

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_3/media/image101.png"  class="common_img" style="width:300px;" ></div>

### 3.27.6 Programming

#### (1) Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_3/media/image102.png"  class="common_img" style="width:250px;" ></div>

#### (2) Core Blocks Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image17.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the selected port to prepare for reading line detection data |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image18.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 270° block servo with the specified id to run continuously at the set angle and running time |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image16.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detection status of the specified channel of the 4-channel line follower sensor and return a boolean value to determine whether a black or white line is detected at the corresponding position |
| <img src="../_static/media/chapter_3/section_3/subsection_3/media/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |

#### (3) MCP Parameter Configuration

* Tool Name: `self.robot.setAction`

1. Tool Description: You are a dump trucank that can control the start d stop of the transportation. The parameters are as follows: 1. Switch: 0 or 1. When it is on, it returns 1; when it is off, it returns 0.
...
5. Function: This MCP configuration defines the transportation start and stop control tool of the dump truck for the AI module. It allows the AI to issue a 0 or 1 command to control the dump truck to start or stop transportation, returning 1 when opened and 0 when closed. The program will wait for the operation to complete during the call, and there is no need to send additional operation data back to the AI.

#### (4) Complete Program

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_3/media/image1.png"  class="common_img" style="width:900px;" ></div>

Program link: https://makecode.microbit.org/_JPLhy3Wso48W. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Pressing button **A** starts a timer as the dumper begins transport, displaying the elapsed seconds on the dot matrix. The unloading process stops automatically upon completion or by pressing button **B**, and the screen scrolls the total elapsed time.
...
This is a smart catapult car capable of launching on command. Upon powering on, it enters a standby state. The WonderLLM large model supports controlling the catapult function using any voice commands. When the ultrasonic sensor detects that an obstacle in front is within the launching range, the servo automatically drives the catapult arm to execute the launch. Like an ancient siege warrior, it uses voice commands to strike targets precisely.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_4/media/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.28.2 Learning Objectives

1. Understand the catapult servo, the ultrasonic sensor, and the WonderLLM online large AI model, mastering hardware wiring and initialization programming logic.
2. Comprehend the tool call interaction logic of the large AI model, mastering coordinated control of ultrasonic distance measurement and automated servo launching.

### 3.28.3 Assembly Guide

 <iframe
    src="../_static/pdf/28_Catapult_Car.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the glowing ultrasonic sensor to port 6 of the micro:bit expansion board.

- Connect the left 360° block servo to port S1 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S1.

- Connect the right 360° block servo to port S2 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S2.

- Connect the 270° block servo to port S4 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S4.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_4/media/image100.png"  class="common_img" style="width:500px;" ></div>

> [!NOTE]
>
> **Before the first lesson involving the block servo, remove the gear from the servo and upload the program for this lesson to the micro:bit. Then turn on the power switch of the micro:bit expansion board and wait for the block servo to rotate to the initial position of 0 degrees before reinstalling the gear. The Catapult Car will be in an inclined state at this moment. This step can be skipped if the servo reset program has been executed previously.**

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_4/media/image101.1.png"  class="common_img" style="width:300px;" ></div>

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_4/media/image101.2.png"  class="common_img" style="width:300px;" ></div>

### 3.28.6 Programming

#### (1) Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_4/media/image102.png"  class="common_img" style="width:300px;" ></div>

#### (2) Core Blocks Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image14.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store interaction data    |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ai module on the specified port to establish a hardware communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for distance measurement |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 270° block servo with the specified id to rotate to the set angle with a limited running duration |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize the status information indicating completed tool execution to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Return the calculated data back to the ai module for processing |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Concatenate all data in the array and convert it into a text string |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image12.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the mcp tool parameter configuration process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the measurement in centimeters |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image16.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image51.png" class="inline-icon"> | Determine whether the target text contains the specified character content |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image17.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image51.png" class="inline-icon"> | Convert data formats like numbers or booleans into standard text format |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image18.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Define array elements and assign them to the specified array variable `list` |
| <img src="../_static/media/chapter_3/section_3/subsection_4/media/image19.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Create an empty array with no elements for subsequent data storage |

#### (3) MCP Parameter Configuration

* Tool Name: `self.robot.setDistance`

1. Tool Description: Data can be obtained from the ultrasonic sensor without specifying parameters. After issuing an instruction, a list will be returned to you, with the first item being the distance from the object. The unit is in centimeters.

2. AIModule Return Parameters: `[["setDistance","string"]]`

   > [!NOTE]
   >
   > **The field name is `setDistance`, of string type.**

3. Whether to block until the call is completed: `true`

4. Whether there is data returned to the AIModule: `true`

5. Function: This MCP configuration defines the ultrasonic ranging tool for the AI module. It allows the AI to obtain object distance data in centimeters from the ultrasonic sensor without issuing parameters. The returned result is a list where the first item is the distance value. The program will wait for the data reading to complete during the call and return the ranging result to the AI module for subsequent decisions.

* Tool Name: `self.robot.launch`

1. Tool Description: It is necessary to control the thrower to be called during launch, returning parameter 1 when launching and parameter 0 when not launching. When the distance range of the object is between 15-20 centimeters, it can be launched, otherwise it will not be launched.

2. AIModule Return Parameters: `[["launch","int","0","1"]]`

   > [!NOTE]
   >
   > **The field name is `launch`, of integer type, where the default value is 0 and the minimum value is 1.**

3. Whether to block until the call is completed: `true`

4. Whether there is data returned to the AIModule: `false`

5. Function: This MCP configuration defines the Catapult Car launch control tool for the AI module. It allows the AI to issue a 0 or 1 command to control whether the Catapult Car executes the launch, returning 1 when launching and 0 when not launching. Launch is only permitted when the object distance is within the range of 15 to 20 centimeters. Otherwise, it will not be executed. The program will wait for the operation to complete during the call, and there is no need to send additional operation data back to the AI.

#### (4) Complete Program

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_4/media/image1.png"  class="common_img" style="width:900px;" ></div>

Program link: https://makecode.microbit.org/_YmC37Y1C5KCb. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Add a launch counter: the dot matrix display increments its count after each launch. When the count exceeds 10, the RGB LEDs cycle through colors corresponding to numbers 0 to 9 every 100 milliseconds, and pressing button **B** resets the count.
...
This is a smart knight robot capable of charging on command. Upon powering on, it enters a standby state. The WonderLLM large model supports controlling the knight to move forward, backward, left, or right using voice commands. During a forward sprint, the right arm is raised. When the ultrasonic sensor detects an obstacle, its left arm is raised, and the robot reverses. When the path is clear, the RGB lights glow green, and it tracks lines. When an obstacle is detected, the lights turn red and an alarm is triggered. Like a brave mechanical knight, it uses smart perception and voice commands to complete line-tracking and obstacle avoidance tasks.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.29.2 Learning Objectives

1. Understand dual 360° block motors, dual 270° block servos, the ultrasonic sensor, the 4-channel line follower sensor, and the large AI model, mastering coordinated wiring and programming for multiple components.
2. Master the control logic of voice-activated movement, servo arm actions, and ultrasonic audio-visual warnings combined with line following.

### 3.29.3 Assembly Guide

 <iframe
    src="../_static/pdf/29_Smart_Knight.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the 4-channel line follower sensor to port 3 of the micro:bit expansion board.

- Connect the left 360° block servo to port S1 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S1.

- Connect the right 360° block servo to port S2 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S2.

- Connect the 270° block servo controlling the shield to port S4 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S4.

- Connect the 270° block servo controlling the right hand to port S5 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S5.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/image100.png"  class="common_img" style="width:500px;" ></div>

> [!NOTE]
>
> **Before the first lesson involving the block servo, remove the building blocks from the left and right servos and upload the program for this lesson to the micro:bit. Then turn on the power switch of the micro:bit expansion board and wait for all block servos to rotate to the initial position of 0 degrees before reinstalling the corresponding building blocks. This step can be skipped if the servo reset program has been executed previously.**

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/image101.png"  class="common_img" style="width:300px;" ></div>

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/image102.png"  class="common_img" style="width:300px;" ></div>

### 3.29.6 Programming

#### (1) Mode 1 Voice Controlled Movement

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 1/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |
...
> [!NOTE]
>
> * **The field name is `robot`, of string type**
>
> * **The field name is `move`, of integer type, where the first 0 is the default value, the second 0 is the minimum value, and 4 is the maximum value**
>
> * **The field name is `time`, of integer type, where the default value is 2000, the minimum value is 0, and the maximum value is 10000**

3. Whether to block until the call is completed: `true`

4. Whether there is data returned to the AIModule: `false`

5. Function: This MCP configuration defines the movement control tool of the smart knight robot for the AI module. It allows the AI to issue direction commands, including forward, backward, left turn, and right turn, returning 1, 2, 3, or 4, respectively, and a movement duration in milliseconds, with a default of 2000 and a range of 0 to 10000, to control the robot's movement. The program will wait for the movement to complete during the call, and there is no need to send additional operation data back to the AI.

- #### Complete Program

  Program link: https://makecode.microbit.org/_YmC37Y1C5KCb. Click **Edit Code** in the upper-right corner of the page to download the complete program.

#### (2) Mode 2 Retreat on Obstacle

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for reading color data |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the specified servo to rotate to the set angle with a limited running duration |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the specified 360° servo to run continuously in a custom direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 2/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the value in centimeters |

- #### Complete Program

  Program link: https://makecode.microbit.org/_PLtfDLV6tP9R. Click **Edit Code** in the upper-right corner of the page to download the complete program.

#### (3) Mode 3 Line Following and Obstacle Avoidance

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image43.png"> | Play the specified note, set the playing beat, and play it completely until the end |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the specified port to prepare for reading line following data |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for distance measurement |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the status of the line follower sensor of the specified channel and return the boolean judgment result |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the measurement in centimeters |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Set the display color of the built-in RGB lights of the ultrasonic sensor to switch light effects |
| <img src="../_static/media/chapter_3/section_3/subsection_5/media/Play Method 3/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image49.png" class="inline-icon"> | Call the custom function with the specified name to execute the encapsulated program logic |

- #### Complete Program

  Program link: https://makecode.microbit.org/_h8j8hzK56DTf. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Pressing button **A** triggers a preset performance sequence: the knight sprints forward for 3 seconds, lifts its right arm, reverses for 3 seconds, and lifts its left arm, looping continuously until middle sensors detect the line. Pressing button **B** stops the performance.

### 3.29.9 Technical Support and Discussion

Join the forum for sharing questions, ideas, or suggestions, and answers will be provided promptly. Click the hyperlink [Hiwonder Forum](http://forum.hiwonder.com) or enter the URL in a browser: http://forum.hiwonder.com

## 3.30 Smart Avoidance Car



### 3.30.1 Introduction

This is a smart avoidance car capable of cruising on command. Upon powering on, it enters a standby state. The WonderLLM large model supports voice control for moving forward, backward, left, or right. It can follow black lines stably. After stopping, the servo drives the ultrasonic probe to swing left, front, and right to scan the distance of obstacles. Like a vigilant scout, it uses keen environmental awareness and flexible motion control to complete line following and obstacle avoidance tasks.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.30.2 Learning Objectives

1. Understand the 360° block motors, 270° scanning servo, ultrasonic sensor, 4-channel line follower sensor, and the WonderLLM large AI model, mastering multi-device wiring and coordinated programming.
2. Master three types of functional logic: line-tracking cruise, servo scanning distance measurement, and voice-controlled mobility.

### 3.30.3 Assembly Guide

 <iframe
    src="../_static/pdf/30_Smart_Avoidance_Car.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the glowing ultrasonic sensor to port 3 of the micro:bit expansion board.

- Connect the 4-channel line follower sensor to port 6 of the micro:bit expansion board.

- Connect the left 360° block servo to port S4 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S4.

- Connect the right 360° block servo to port S5 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S5.

- Connect the 270° block servo to port S1 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S1.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/image100.png"  class="common_img" style="width:500px;" ></div>

### 3.30.6 Programming

#### (1) Mode 1 Line Following Cruise

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 1/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 1/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 1/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 1/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the custom port to prepare for reading line detection data |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 1/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 1/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detection status of the specified channel of the 4-channel line follower sensor and return a boolean value for line following logic judgment |

- #### Complete Program

  Program link: https://makecode.microbit.org/_a5ThYtfMPLmF. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image44.png"> | Loop the internal program code continuously when the judgment condition result is false |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image45.png" class="inline-icon"> | Perform true/false negation operation on the input boolean judgment result |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the specified port to prepare for reading line following data |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for distance measurement |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image12.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 270° block servo with the specified id to run continuously at the set angle and running time |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the status of the line follower sensor of the specified channel and return the boolean judgment result |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the measurement in centimeters |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the sensing status of the specified channel of the single line follower sensor and output the boolean result of hardware detection |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 2/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image49.png" class="inline-icon"> | Call the custom function with the specified name to execute the encapsulated program logic |

- #### Complete Program

  Program link: https://makecode.microbit.org/_2FyEfc8ojFYM. Click **Edit Code** in the upper-right corner of the page to download the complete program.

#### (3) Mode 3 Voice Controlled Movement

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_6/media/Play Method 3/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |
...
5. Function: This MCP configuration defines the movement control tool of the smart avoidance car for the AI module. It allows the AI to issue direction commands, including forward, backward, left turn, and right turn, returning 1, 2, 3, or 4, respectively, and a movement duration in milliseconds, with a default of 2000 and a range of 0 to 10000, to control the robot's movement. The program will wait for the movement to complete during the call, and there is no need to send additional operation data back to the AI.

- #### Complete Program

  Program link: https://makecode.microbit.org/_5YALm1EYYgV1. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Pressing button **A** starts a timer during line-tracking cruise, displaying the elapsed seconds on the dot matrix. The cruise halts automatically when sensors detect the line boundary or when button **B** is pressed, and the screen scrolls the total elapsed time.
...
This is a multifunctional tank clawbot capable of working on command. Upon powering on, it enters a standby state. The WonderLLM large model supports voice control for moving forward, backward, left, or right. During line following, when the ultrasonic sensor detects an obstacle within 20 cm, it automatically halts line following and executes claw grabbing and placing sequences. Like an all-round engineering assistant, it uses voice commands to complete line following and grabbing tasks.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.31.2 Learning Objectives

1. Understand 360° block motors, the 270° grabbing servo, the ultrasonic sensor, the 4-channel line follower sensor, and the large AI model, mastering coordinated wiring and programming for multiple components.
2. Master controlling tracked movement via voice, comprehending ultrasonic distance thresholds to automate line-tracking cruise and claw grabbing.

### 3.31.3 Assembly Guide

 <iframe
    src="../_static/pdf/31_Tank_Clawbot.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the glowing ultrasonic sensor to port 4 of the micro:bit expansion board.
...
<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_7/media/image100.png"  class="common_img" style="width:500px;" ></div>

> [!NOTE]
>
> **Before the first lesson involving the block servo, remove the gear from the servo and upload the program for this lesson to the micro:bit. Then turn on the power switch of the micro:bit expansion board and wait for the block servo to rotate to the initial position of 0 degrees before reinstalling the gear. The mechanical claw will be in an open state at this moment. This step can be skipped if the servo reset program has been executed previously.**

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_7/media/image101.png"  class="common_img" style="width:300px;" ></div>

### 3.31.6 Programming

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image100.gif"  class="common_img" style="width:500px;" ></div>

#### (1) Mode 1 Voice Controlled Movement

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 1/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |
...
5. Function: This MCP configuration defines the movement control tool of the Tank Clawbot for the AI module. It allows the AI to issue direction commands including forward, backward, left turn, and right turn, returning 1, 2, 3, or 4 respectively, and movement duration in milliseconds, with a default of 2000 and a range of 0 to 10000, to control the tracked car movement. The program will wait for the movement to complete during the call, and there is no need to send additional operation data back to the AI.

- #### Complete Program

  Program link: https://makecode.microbit.org/_7b50CJCDDXeW. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for distance measurement |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the specified port to prepare for reading line following data |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 270° block servo with the specified id to rotate to the set angle with a limited running duration |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the measurement in centimeters |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the status of the line follower sensor of the specified channel and return the boolean judgment result |
| <img src="../_static/media/chapter_3/section_3/subsection_7/media/Play Method 2/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image49.png" class="inline-icon"> | Call the custom function with the specified name to execute the encapsulated program logic |

- #### Complete Program

  Program link: https://makecode.microbit.org/_MheK7YAg9eos. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Pressing button **A** cycles the grab trigger distance setting between 10 cm, 15 cm, and 20 cm, while pressing button **B** starts execution of the grabber robot.
...
This is a smart tank car capable of voice-controlled hazard prevention. Upon powering on, it enters a standby state. The WonderLLM large model supports controlling the robot's movement using voice commands. During line following, when the ultrasonic sensor detects an obstacle in front within 20 cm, the car automatically stops, while the controller triggers a buzzer alarm and starts the fan to cool the area. Like an intelligent safety monitor, it automatically completes environmental monitoring and emergency response tasks.

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image100.gif"  class="common_img" style="width:500px;" ></div>

### 3.32.2 Learning Objectives

1. Understand 360° block motors, the 270° block servo, the ultrasonic sensor, the 4-channel line follower sensor, the fan module, and the large AI model, mastering coordinated wiring and programming.
2. Master voice-controlled movement, ultrasonic audio-visual warnings, and automated ventilation upon obstacle detection to simulate smart operations.

### 3.32.3 Assembly Guide

 <iframe
    src="../_static/pdf/32_Smart_Tank_Car.pdf#view=FitH"
    title="Assembly Guide PDF"
    width="100%"
    height="850"
    style="border: 1px solid #ddd;"
...
- Connect the fan module to port 1 of the micro:bit expansion board.

- Connect the left 360° block servo to port S1 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S1.

- Connect the right 360° block servo to port S2 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S2.

- Connect the 270° block servo controlling the fan to port S4 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S4.

- Connect the 270° block servo controlling the right hand to port S5 of the micro:bit expansion board, ensuring the yellow wire of the servo is inserted into the white pin of S5.

  As shown in the following image:

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/image100.png"  class="common_img" style="width:500px;" ></div>

> [!NOTE]
>
> **Before the first lesson involving the block servo, remove the building blocks from the left and right servos, and upload the following 270 degree servo reset program to the micro:bit. Then turn on the power switch of the micro:bit expansion board, and wait for all block servos to reset before reinstalling the removed building blocks. Next, upload the program for this lesson to the micro:bit and wait for the block servos to rotate to their initial positions of negative 15 degrees for the left servo and 0 degrees for the right servo. This step can be skipped if the servo reset program has been executed previously.**

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/image103.png"  class="common_img" style="width:300px;" ></div>

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/image101.png"  class="common_img" style="width:300px;" ></div>

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/image102.png"  class="common_img" style="width:300px;" ></div>

### 3.32.6 Programming

#### (1) Mode 1 Voice Controlled Movement

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image13.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store data                |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom variables                            |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent use  |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the WonderLLM interface and establish the module communication connection |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Configure custom function tool parameters callable by the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Synchronize mcp tool configuration information to the ai module |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the running data returned after the ai module calls a tool |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Extract the corresponding numeric value from the target dictionary based on the specified key and return it |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image15.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Inform the ai module that the single tool call process has ended |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set rotation direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 1/image11.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image50.png" class="inline-icon"> | Determine whether the target text contains the specified characters |
...
5. Function: This MCP configuration defines the movement control tool of the Smart Tank Car for the AI module. It allows the AI to issue direction commands including forward, backward, left turn, and right turn, returning 1, 2, 3, or 4 respectively, and movement duration in milliseconds, with a default of 2000 and a range of 0 to 10000, to control the tracked car movement. The program will wait for the movement to complete during the call, and there is no need to send additional operation data back to the AI.

- #### Complete Program

  Program link: https://makecode.microbit.org/_7mVaPV8xxP6s. Click **Edit Code** in the upper-right corner of the page to download the complete program.

#### (2) Mode 2 Line Following and Obstacle Avoidance

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image43.png"> | Play the specified note, set the playing beat, and play it completely until the end |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the 4-channel line follower sensor hardware on the specified port to prepare for reading line following data |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for distance measurement |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the status of the line follower sensor of the specified channel and return the boolean judgment result |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the measurement in centimeters |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Set the display color of the built-in RGB lights of the ultrasonic sensor to switch light effects |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 2/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image49.png" class="inline-icon"> | Call the custom function with the specified name to execute the encapsulated program logic |

- #### Complete Program

  Program link: https://makecode.microbit.org/_LR3W3FaY87Ud. Click **Edit Code** in the upper-right corner of the page to download the complete program.

#### (3) Mode 3 Fan Activation

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image100.gif"  class="common_img" style="width:500px;" ></div>

- #### Program Flowchart

<div align="center"><img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image102.png"  class="common_img" style="width:300px;" ></div>

- #### Core Block Analysis

| Block                                                        | Category                                                     | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image8.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Define or obtain variables used to store distance values     |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image9.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image46.png"> | Assign values to custom distance variables                   |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image2.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the DaDabit module to prepare for subsequent hardware use |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image3.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the fan module hardware on the specified port to prepare for adjusting rotation speed |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image4.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Initialize the ultrasonic sensor hardware on the specified port to prepare for distance measurement |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image5.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 270° block servo with the specified id to rotate to the set angle with a limited running duration |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image6.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Control the 360° block servo with the specified id to run continuously in the set direction and speed |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image7.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Set the fan rotation speed with the parameter ranging from 0 to 100 |
| <img src="../_static/media/chapter_3/section_3/subsection_8/media/Play Method 3/image10.png"> | <img src="../_static/media/chapter_3/section_1/subsection_1/media/image48.png"> | Read the detected distance from the ultrasonic sensor and return the measurement in centimeters |

- #### Complete Program

  Program link: https://makecode.microbit.org/_KY259jHc2i0A. Click **Edit Code** in the upper-right corner of the page to download the complete program.
...
Introduce RGB light control in the MCP tool parameters to change colors via voice. Additionally, temperature-linked control automatically starts the fan when the ambient temperature exceeds 86°F and stops it when it drops below 77°F.
