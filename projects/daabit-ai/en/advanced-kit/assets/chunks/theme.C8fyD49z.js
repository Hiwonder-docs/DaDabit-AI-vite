const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.nUKRSQ--.js","assets/chunks/framework.CtwzKPAY.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.nUKRSQ--.js"), true ? __vite__mapDeps([0,1]) : void 0));
