...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/projects/daabit-ai/en/advanced-kit/";
...
const assetsURL = function(dep) {
  return "/projects/daabit-ai/en/advanced-kit/" + dep;
};
const seen = {};
...
export {
  ...
  notNullish as am,
  computedAsync as an,
  useSessionStorage as ao,
  useLocalStorage as ap,
  watchDebounced as aq,
  useRouter as ar,
  useEventListener as as,
  withDirectives as at,
  vModelText as au,
  isRef as av,
  markRaw as aw,
  createApp as ax,
