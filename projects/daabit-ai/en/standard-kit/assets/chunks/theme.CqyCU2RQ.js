...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.C6snBqts.js"), true ? __vite__mapDeps([0,1]) : void 0));
